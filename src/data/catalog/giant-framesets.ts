...
export const giantFramesets: Bicycle[] = [
  {
    ...
    price: { amount: 4400, currency: "USD", region: "US" },
  ...
  },
  {
    ...
    price: { amount: 3200, currency: "USD", region: "US" },
  ...
  },
  {
    ...
    recommendationTags: ["aero", "race", "speed", "premium"],
    price: { amount: 4300, currency: "USD", region: "US" },
    priceNote: "US 官方目录价格 US$4,300，维持原币种。",
    referencePrice: {
      amount: 25000,
      currency: "CNY",
      region: "CN",
      note: "需求提及中国区 Advanced SL 车架组约 ¥25,000 级别、特别/队版约 ¥30,000；本次未在中国站核实到该车架组页面，故仅作参考。",
    },
    weights: [],
