...
type ProductSelectorProps = { category: ComponentCategory; products: Component[]; selectedId?: string; selectedSize?: string; onSelect: (id: string) => void; onSizeChange: (size: string) => void };

export function ProductSelector({ category, products, selectedId, selectedSize, onSelect, onSizeChange }: ProductSelectorProps) {
